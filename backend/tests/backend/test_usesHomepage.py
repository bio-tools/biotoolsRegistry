...
class TestUsesHomepage(BaseTestObject):
	...
	def test_usesHomepage_empty_none(self):
		...
		response = self.client.get('/tool/test_usesHomepage_empty_none')
	...
	def test_usesHomepage_empty_zero_length(self):
		...
		response = self.client.get('/tool/test_usesHomepage_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_300_length(self):
		...
		response = self.client.get('/tool/test_usesHomepage_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesHomepage_301_length(self):
		...
		response = self.client.get('/tool/test_usesHomepage_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_non_ascii(self):
		...
		sent_resource['uses'] = [
			{
				'usesName': 'just a usesName',
				'usesHomepage': u'http://ąęćżźń£ØΔ♥†.com'
			}
		]
		...
		response = self.client.get('/tool/test_usesHomepage_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_usesHomepage_incorrect(self):
		...
		response = self.client.get('/tool/test_usesHomepage_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_array(self):
		...
		response = self.client.get('/tool/test_usesHomepage_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_dict(self):
		...
		response = self.client.get('/tool/test_usesHomepage_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_number(self):
		...
		response = self.client.get('/tool/test_usesHomepage_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_usesHomepage_case_sensitive(self):
		...
		response = self.client.get('/tool/test_usesHomepage_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
