...
class TestCreditsInfrastructure(BaseTestObject):
	...
	def test_creditsInfrastructure_correct_1(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_correct_1', format='json')
	...
	def test_creditsInfrastructure_correct_2(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_correct_2', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsInfrastructure_empty_none(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_empty_none')
	...
	def test_creditsInfrastructure_empty_zero_length(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_300_length(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsInfrastructure_301_length(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_non_ascii(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_creditsInfrastructure_array(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_dict(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_number(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_array_number(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_array_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_creditsInfrastructure_duplicate(self):
		...
		response = self.client.get('/tool/test_creditsInfrastructure_duplicate', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
