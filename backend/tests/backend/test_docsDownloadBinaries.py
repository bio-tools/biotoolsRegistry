...
class TestDocsDownloadBinaries(BaseTestObject):
	...
	def test_docsDownloadBinaries_correct(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_correct', format='json')
	...
	def test_docsDownloadBinaries_empty_none(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_empty_none')
	...
	def test_docsDownloadBinaries_empty_zero_length(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_empty_zero_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_300_length(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_300_length', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsDownloadBinaries_301_length(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_301_length')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_non_ascii(self):
		...
		sent_resource['docs'] = {
			'docsDownloadBinaries': u'http://ąęćżźń£ØΔ♥†.com'
		}

		response = self.client.post('/tool/', sent_resource, format='json')
		self.assertEqual(response.status_code, status.HTTP_201_CREATED)

		response = self.client.get('/tool/test_docsDownloadBinaries_non_ascii', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
	...
	def test_docsDownloadBinaries_incorrect(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_incorrect')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_array(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_dict(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_dict')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_number(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_docsDownloadBinaries_case_sensitive(self):
		...
		response = self.client.get('/tool/test_docsDownloadBinaries_case_sensitive', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)
