...
class TestInputDataType(BaseTestObject):
	...
	def test_input_dataType_Pass_URI_only(self):
		...
		sent_resource['id'] = 'test_input_dataType_Pass_URI_only'
		...
		response = self.client.get('/tool/test_input_dataType_Pass_URI_only', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputTool()

		expected_resource['id'] = 'test_input_dataType_Pass_URI_only'
	...
	def test_input_dataType_Pass_term_only(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_input_dataType_Pass_term_only'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_input_dataType_Pass_term_only', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputTool()

		expected_resource['id'] = 'test_input_dataType_Pass_term_only'
		expected_resource['function'] = [
			{
				'operation': [
					{
	...
	def test_input_dataType_Pass_URI_term(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_input_dataType_Pass_URI_term'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_input_dataType_Pass_URI_term', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputTool()

		expected_resource['id'] = 'test_input_dataType_Pass_URI_term'
		expected_resource['function'] = [
			{
				'operation': [
					{
	...
	def test_Obsolete_input_dataType_URI(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_Obsolete_input_dataType_URI'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_Obsolete_input_dataType_URI')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)


	def test_Obsolete_input_dataType_term(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_Obsolete_input_dataType_term'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_Obsolete_input_dataType_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)


	def test_Obsolete_input_dataType_URI_term(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_Obsolete_input_dataType_URI_term'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_Obsolete_input_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_incorrect_input_dataType_term(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_incorrect_input_dataType_term'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_incorrect_input_dataType_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)


	def test_incorrect_input_dataType_URI_term(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_incorrect_input_dataType_URI_term'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_incorrect_input_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_mismatch_correct_inp_dataType_URI_term(self):
		...
		response = self.client.get('/tool/test_mismatch_correct_inp_dataType_URI_term')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)
	...
	def test_inp_dataType_array(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_inp_dataType_array'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_inp_dataType_array')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)


	def test_inp_dataType_number(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_inp_dataType_number'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_inp_dataType_number')
		self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
		self.assertEqual(json.loads(response.content), expected_response)


	def test_inp_dataType_extra_fields(self):
		...
		"""
		sent_resource = emptyInputTool()
		sent_resource['id'] = 'test_inp_dataType_extra_fields'
		sent_resource['function'] = [
			{
				'operation': [
					{
		...
		response = self.client.get('/tool/test_inp_dataType_extra_fields', format='json')
		self.assertEqual(response.status_code, status.HTTP_200_OK)

		expected_resource = emptyOutputTool()

		expected_resource['id'] = 'test_inp_dataType_extra_fields'
		expected_resource['function'] = [
			{
				'operation': [
					{
