...
class Resource(models.Model):
    ...
    HOMEPAGE_STATUS_CHOICES = ((0, "UP"), (1, "DOWN"), (2, "DEAD"))
    ...
    biotoolsCURIE = models.CharField(
        blank=False, null=False, max_length=109
    )  # because of biotools: prefix
    ...
    elixirInfo = models.ForeignKey(
        ElixirInfo, null=True, blank=True, on_delete=models.CASCADE
    )
    editPermission = models.ForeignKey(
        EditPermission, null=False, blank=True, on_delete=models.CASCADE
    )
...
class ResourceRequest(models.Model):
    ...
    user = models.ForeignKey(
        User, related_name="requests", blank=True, null=True, on_delete=models.CASCADE
    )
