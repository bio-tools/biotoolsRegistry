...
class Input(models.Model):
    ...
    function = models.ForeignKey(
        Function, null=True, blank=True, related_name="input", on_delete=models.CASCADE
    )
...
class Output(models.Model):
    ...
    function = models.ForeignKey(
        Function, null=True, blank=True, related_name="output", on_delete=models.CASCADE
    )
    # forward relationship, because one data
    data = models.ForeignKey(Data, null=True, blank=False, on_delete=models.CASCADE)
...
class Format(models.Model):
    ...
    input = models.ForeignKey(
        Input, null=True, blank=True, related_name="format", on_delete=models.CASCADE
    )
    output = models.ForeignKey(
        Output, null=True, blank=True, related_name="format", on_delete=models.CASCADE
    )
