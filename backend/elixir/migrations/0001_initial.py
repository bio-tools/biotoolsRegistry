    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elixir_badge', models.IntegerField(default=0, choices=[(0, b'None'), (1, b'EDD'), (2, b'CDR'), (3, b'EDD,CDR'), (4, b'RIR'), (5, b'EDD,RIR'), (6, b'CDR,RIR'), (7, b'EDD,CDR,RIR')])),
        ...
        migrations.AddField(
            model_name='relation',
            name='resource',
            field=models.ForeignKey(related_name='relation', blank=True, to='elixir.Resource', null=True),
        ),
        migrations.AddField(
