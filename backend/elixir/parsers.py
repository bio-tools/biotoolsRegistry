...
class XMLSchemaParser(BaseParser):
    ...
    def parse(self, stream, media_type=None, parser_context=None):
        ...
        with open(
            "/elixir/application/backend/elixir/biotoolsSchema/biotools_3.3.0-singletool.xsd",
            "r",
        ) as f:
        ...
        try:
            ...
            xslt1 = lxmletree.parse(
                "/elixir/application/backend/elixir/biotoolsSchema/biotoolsSchema_3.3.0_XML_to_framework_XML_xslt1.0.xslt"
            )
            ...
            raise ParseError(
                "XML validation error - %s -- Note that you can only register one tool at a time."
                % e
            )
