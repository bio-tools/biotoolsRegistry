...
urlpatterns = [
	...
	url(r'^t(ool)?/(?P<textId>[a-zA-Z0-9.~_-]+)/?$', views.ResourceDetail.as_view()),
	url(r'^t(ool)?/(?P<textId>[a-zA-Z0-9.~_-]+)/validate/?$', views.ResourceUpdateValidator.as_view()),
	url(r'^t(ool)?/(?P<textId>[a-zA-Z0-9.~_-]+)/i(ssues)?/(?P<issueId>[a-zA-Z0-9.~_-]+)?$', views.IssueView.as_view()),
	url(r'^t(ool)?/(?P<textId>[a-zA-Z0-9.~_-]+)/disown/?$', views.DisownResourceView.as_view()),
	...
	url(r'^(?P<textId>[a-zA-Z0-9.~_-]+)/?$', views.ResourceDetail.as_view()),
	url(r'^(?P<textId>[a-zA-Z0-9.~_-]+)/validate/?$', views.ResourceUpdateValidator.as_view()),
	url(r'^(?P<textId>[a-zA-Z0-9.~_-]+)/i(ssues)?/(?P<issueId>[a-zA-Z0-9.~_-]+)?$', views.IssueView.as_view()),
	url(r'^(?P<textId>[a-zA-Z0-9.~_-]+)/disown/?$', views.DisownResourceView.as_view()),
]
