...
class ToolTypeSerializer(serializers.ModelSerializer):
	...
	def to_internal_value(self, data):
		...
		enum = ENUMValidator(['Bioinformatics portal','Command-line tool', 'Web application', 'Desktop application', 'Script', 'Suite', 'Workbench', 'Database portal', 'Ontology', 'Workflow', 'Plug-in', 'Library', 'Web API', 'Web service', 'SPARQL endpoint'])
		data = enum(data)
		return {'name': data}