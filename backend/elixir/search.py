...
def format_search(
    attribute, search_field, search_text, search_struct, elastic_query, query_type
):
...
def get_list_of_terms(field):
    query_struct = {
        "size": 0,
        "aggs": {field: {"terms": {"field": field, "size": 50000}}},
    }
...
def construct_es_query(query_dict):
    ...
    if sort_attribute and (
        ...
        query_struct["sort"] = {sort_attribute: {"order": sort_order}}

    query_struct["query"]["bool"] = {"must": [], "should": []}
            ...
            dis_max = {
                "dis_max": {
                    "queries": [
                        ...
                        {
                            "match_phrase": {
                                "description": {"query": term, "boost": 0.05}
                            }
                        },
                        {
                            "match_phrase": {
                                "collectionID": {"query": term, "boost": 4.0}
                            }
                        },
                        {"match_phrase": {"topic.term": {"query": term, "boost": 0.5}}},
                        {
                            "match_phrase": {
                                "function.operation.term": {"query": term, "boost": 0.5}
                            }
                        },
                        {
                            "match_phrase": {
                        ...
                        {
                            "match_phrase": {
                                "function.note": {"query": term, "boost": 0.5}
                            }
                        },
                        # { "match_phrase": { "contact.name":  {"query": term, "boost": 0.5 } }},
                        {
                            "match_phrase": {
                                "credit.name": {"query": term, "boost": 0.5}
                            }
                        },
                        {
                            "match_phrase": {
                                "credit.note": {"query": term, "boost": 0.05}
                            }
                        },
                        {
                            "match_phrase": {
                                "documentation.note": {"query": term, "boost": 0.05}
                            }
                        },
                        ...
                        {
                            "match_phrase": {
                                "operatingSystem": {"query": term, "boost": 0.5}
                            }
                        },
                        {"match_phrase": {"toolType": {"query": term, "boost": 0.5}}},
                        {
                            "match_phrase": {
                                "version.version": {"query": term, "boost": 1.0}
                            }
                        },
                    ],
                    "tie_breaker": 0.6,
            ...
            dis_max = {
                "dis_max": {
                    "queries": [
                        ...
                        {
                            "wildcard": {
                                "name.raw": {"value": "*" + term + "*", "boost": 100.0}
                            }
                        },
