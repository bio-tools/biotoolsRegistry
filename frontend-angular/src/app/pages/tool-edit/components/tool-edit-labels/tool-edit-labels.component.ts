...
import { Tool, Topic, ToolType } from '../../../../models/tool.model';
...
@Component({
  ...
  templateUrl: './tool-edit-labels.component.html',
  styleUrls: ['./tool-edit-labels.component.scss']
})
export class ToolEditLabelsComponent implements OnInit {
