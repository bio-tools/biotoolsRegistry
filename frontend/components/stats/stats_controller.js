angular
    ...
    .factory('TotalAnnotationsStatsData', [
        '$resource',
        function ($resource) {
    ...
    .service('StatsDataSource', [
        '$stateParams',
        'Stats',
        'StatsTotalEntries',
        'StatsUserData',
        'TotalAnnotationsStatsData',
        function (
            $stateParams,
            Stats,
            StatsTotalEntries,
...
angular.module('elixir_front.controllers').controller('StatsController', [
    '$scope',
    '$http',
    'StatsDataSource',
    function ($scope, $http, StatsDataSource) {
        // Initialization
        var _this = this;
        $scope.labels = [];
        $scope.labelsUsers = [];
        ...
        $scope.seriesTotalAnnotationDetail = [
            'Name',
            'Description',
            'Homepage',
            'Tool Type',
