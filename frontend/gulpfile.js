...
gulp.task('copy', function () {
    ...
    gulp.src('bower_components/angular-tree-control/images/*.png').pipe(
    ...
    // ui-grid
    gulp.src('bower_components/angular-ui-grid/ui-grid.eot').pipe(gulp.dest('dist/fonts'));
    gulp.src('bower_components/angular-ui-grid/ui-grid.svg').pipe(gulp.dest('dist/fonts'));
    gulp.src('bower_components/angular-ui-grid/ui-grid.ttf').pipe(gulp.dest('dist/fonts'));
    gulp.src('bower_components/angular-ui-grid/ui-grid.woff').pipe(gulp.dest('dist/fonts'));
});
