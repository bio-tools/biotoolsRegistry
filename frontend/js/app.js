...
var elixir_front = angular
        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                    ...
                    data: {
                        meta: {
                            ...
                            'og:description':
                                'A registry of bioinformatics software resources including biological databases, analytical tools and data services',
                            'og:image':
                                'https://bio.tools/img/ELIXIR_logo_white_background_small.png',
                        },
                        roles: [],
                    },
                    resolve: {},
                ...
                .state('domains', {
                    ...
                    data: {
                        meta: {
                            ...
                            description:
                                'Explore and search all bio.tools domains and manage your own domains.',
                ...
                .state('events', {
                    url: '/events',
                    redirect:
                        'https://docs.google.com/document/d/1K-6IG_7a-4amstSSOxYjjJ3uDUEg4-WGSSt9jvvO7Ik/edit#heading=h.twop51kvyu80',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('faq', {
                    url: '/faq',
                    redirect:
                        'https://docs.google.com/document/d/1WdcY0WQJVdRHz0BAhII7s8gygxKRJaHZC4gOnAC1eqs/edit',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('apidoc', {
                    url: '/apidoc',
                    redirect:
                        'https://docs.google.com/document/d/1c1zridWLBNSrWcYyR2fnBfgjWfrUSrT7HJ6Ql6ZCkS4/edit#heading=h.9a2zbl9ka0z0',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('changelog', {
                    url: '/changelog',
                    redirect:
                        'https://docs.google.com/document/d/1C5KFu2t4OIAuUpx6dS7Djsa9y3zgicd8naOsAs9QPAY/edit#heading=h.eu5jkfa77et',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('helpdesk', {
                    url: '/helpdesk',
                    redirect:
                        'https://elixir-registry.atlassian.net/servicedesk/customer/portal/2/user/login?destination=portal%2F2',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('projects', {
                    url: '/projects',
                    redirect:
                        'https://docs.google.com/document/d/1QBIZHBzHxxmvSnOG3xK6t3SCeft5g4AH2rVICLRLmDw/edit#heading=h.a6i4b9p7xdw7',
                    external: true,
                    data: {
                        roles: [],
                    },
                ...
                .state('roadmap', {
                    url: '/roadmap',
                    redirect:
                        'https://docs.google.com/document/d/17iH72hmwVo205QVEkptv7GTMlqFojatIwMmxVOyuPy8/edit#heading=h.m1jhkecru8xq',
                    external: true,
                    data: {
                        roles: [],
                    },
    ...
    .run([
        ...
        'djangoAuth',
        '$http',
        function ($rootScope, $state, $timeout, User, djangoAuth, $http) {
            ...
            var authenticationPromise = djangoAuth
                .authenticationStatus(true)
                .then(logInCallback, wrongAuthCallback);
