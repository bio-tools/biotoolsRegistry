...
angular
    ...
    .service('DomainDetailConnection', [
        '$resource',
        function ($resource) {
            return $resource(
                '/api/d/:domain',
    ...
    .service('Domain', [
        'DomainDetailConnection',
        function (DomainDetailConnection) {
            var _this = this;
            this.current = {};
            this.loaded = false;
            ...
            this.load = function (domain) {
                if (typeof domain != 'undefined') {
                    var response = DomainDetailConnection.query(
                        { domain: domain },
                        function (response) {
    ...
    .service('ToolListOverviewConnection', [
        '$resource',
        function ($resource) {
    ...
    .service('ToolList', [
        ...
        'ToolListConnection',
        'ToolPaginator',
        function ($stateParams, ToolListConnection, ToolPaginator) {
            var _this = this;
            this.count = 0;
            this.list = [];
            this.loading = true;
    ...
    .factory('MetaService', function ($document, $window) {
        ...
        return {
            setAlternatesForTool: function (biotoolsID) {
                ...
                setAlternate(
                    'application/json',
                    base + '/api/' + biotoolsID + '?format=json',
                    'JSON'
                );
        ...
        var columnDescriptionForKey = function (key, hidden) {
            ...
            if (key == 'Name') {
                columnDescription = {
                    ...
                    pinnedLeft: true,
                    displayName: 'Name',
                    cellTemplate: '/partials/grid_cells/nameCell.html',
                    width: '150',
                    resizable: true,
                };
                ...
                columnDescription = {
                    ...
                    cellTemplate: '/partials/grid_cells/platformCell.html',
                    width: '100',
                    resizable: true,
                };
                ...
                columnDescription = {
                    ...
                    width: '*',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/defaultCell.html',
                };
                ...
                columnDescription = {
                    ...
                    width: '220',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/functionCell.html',
                };
            } else if (key == 'Input') {
                columnDescription = {
                    field: 'function',
                    ...
                    width: '240',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/inputCell.html',
                };
            } else if (key == 'Output') {
                columnDescription = {
                    field: 'function',
                    ...
                    width: '240',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/outputCell.html',
                };
            } else if (key == 'Topic') {
                columnDescription = {
                    field: 'topic',
                    ...
                    width: '200',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/topicCell.html',
                };
                ...
                columnDescription = {
                    ...
                    resizable: true,
                    width: '100',
                    cellTemplate: '/partials/grid_cells/urlCell.html',
                };
                ...
                columnDescription = {
                    ...
                    width: '150',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/listCell.html',
                };
                ...
                columnDescription = {
                    ...
                    width: '250',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/publicationsCell.html',
                };
                ...
                columnDescription = {
                    ...
                    width: '160',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/linkListCell.html',
                };
            } else if (key == 'Link') {
                columnDescription = {
                    field: 'link',
                ...
                columnDescription = {
                    field: 'credit',
                    displayName: 'Credits & Support',
                    width: '150',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/creditsCell.html',
                };
                ...
                columnDescription = {
                    ...
                    width: '100',
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/dateCell.html',
                };
            } else if (key == 'Updated') {
                columnDescription = {
                    field: 'lastUpdate',
                ...
                columnDescription = {
                    field: key.toLowerCase(),
                    displayName: key,
                    width: key.length * widthCharMultiplier,
                    resizable: true,
                    cellTemplate: '/partials/grid_cells/defaultCell.html',
                };
            }
        ...
        return {
            columnsDescription: function (visibleColumns) {
                return [
                    ...
                    columnDescriptionForKey(
                        'bio.tools ID',
                        visibleColumns.indexOf('bio.tools ID') != -1
                    ),
                    ...
                    columnDescriptionForKey(
                        'Publications',
                        visibleColumns.indexOf('Publications') != -1
                    ),
                    ...
                    columnDescriptionForKey(
                        'Documentation',
                        visibleColumns.indexOf('Documentation') != -1
                    ),
                    columnDescriptionForKey(
                        'Operating System',
                        visibleColumns.indexOf('Operating System') != -1
                    ),
                    ...
                    columnDescriptionForKey(
                        'Accessibility',
                        visibleColumns.indexOf('Accessibility') != -1
                    ),
                    columnDescriptionForKey('Download', visibleColumns.indexOf('Download') != -1),
                    columnDescriptionForKey(
                        'Collection',
                        visibleColumns.indexOf('Collection') != -1
                    ),
    ...
    .service('Attribute', function () {
        this.description = {
            ...
            version: {
                description:
                    "Tool version information. Use 'Add version' to enter individual version numbers (if practical).",
                label: 'Current version',
            },
            description: {
                description:
                    'Tool description, e.g. a few sentences adapted from the tool publication abstract or homepage.',
                label: 'Description',
            },
            operation: {
            ...
            functionNote: {
                description:
                    'Concise comment about this function, if not apparent from the description and EDAM annotations.',
            ...
            topic: {
                description:
                    'A scientific domain that the tool serves, or another general category.',
                label: 'Topic',
            },
            homepage: {
            ...
            sourceRegistry: {
                description:
                    'Link to the registry (or other collection) from which the tool was imported (URL)',
                label: 'Source registry',
            },
            canonicalID: {
                description:
                    'Canonical Identifier (typically a URI) of the resource, if one is available',
                label: 'Canonical ID',
            },
            cost: {
            ...
            license: {
                description:
                    'Software or data usage license. Use "Unlicensed", "Proprietary" (for commercial licenses) or "Other" in special cases. ',
                label: 'License',
            },
            credit: {
            ...
            creditsInfrastructure: {
                description:
                    'Research infrastructure in which the resource was developed or provided',
            ...
            uses: {
                description:
                    'Other resources this resource uses, e.g. as a data source, or auxillary program',
                label: 'Uses',
            },
            usesName: {
            ...
            cmd: {
                description:
                    'Relevant command, command-line fragment or option for executing this function or running the tool in this mode.',
                label: 'Command',
            },
            linkURL: {
            ...
            otherID: {
                description:
                    'A unique identifier of the tool, typically assigned by an ID-assignment authority other than bio.tools, e.g. “RRID:SCR_015644”',
                label: 'otherID',
            },
            otherIDValue: {
            ...
            relationBiotoolsID: {
                description:
                    'bio.tools ID of an existing bio.tools entry to which this tool is related, e.g. "needle"',
                label: 'relationBiotoolsID',
            },
            relationType: {
                description:
                    'Type of relation between this and another registered tool, e.g. "isNewVersionOf"',
                label: 'relationType',
            },
            confidence: {
                description:
                    'Related to automatically generated entries from publications: describes the confidence score of an entry being a valid bio.tools entry.',
    ...
    .factory('CheckUserEditingRights', [
        'User',
        function (User) {
            return {
